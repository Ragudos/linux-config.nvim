...
vim.keymap.set('n', '<leader>s', [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = 'replace & match' })
vim.keymap.set('n', '<leader>x', '<cmd>!chmod +x %<CR>', { silent = true, desc = 'chmod' })

vim.keymap.set('n', '<leader><leader>', function()
  vim.cmd 'so'
end, { desc = 'source file (reload)' })
